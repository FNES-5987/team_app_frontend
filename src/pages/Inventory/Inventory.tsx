...
const InventoryComponent = () => {
  ...
  return (
    <div>
      ...
      <footer>
        <button
          onClick={() => changePageAndPushHistory(1)}
          disabled={page === 1}
        >
          First Page
        </button>
        ...
        <button
          onClick={() =>
            changePageAndPushHistory((prevPage) => Math.max(prevPage - 1), 0)
          }
          disabled={page === 1}
        >
          Previous Page
        ...
        {Array.from({ length: Math.min(pageData.totalPages, 5) }, (_, i) =>
          ...
          <button
            key={pageNum}
            onClick={() => changePageAndPushHistory(pageNum)}
        ...
        <button
          onClick={() => changePageAndPushHistory(pageData.totalPages)}
          disabled={page === pageData.totalPages}
        >
          Last Page
        </button>
